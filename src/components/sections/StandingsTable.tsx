...
const standings = [
  { team: "fc-char7e", played: 0, won: 0, drawn: 0, lost: 0, gf: 0, ga: 0, gd: 0, points: 0 },
  { team: "fc-madrid", played: 0, won: 0, drawn: 0, lost: 0, gf: 0, ga: 0, gd: 0, points: 0 },
  { team: "fc-ehil-dar", played: 0, won: 0, drawn: 0, lost: 0, gf: 0, ga: 0, gd: 0, points: 0 },
  { team: "calemptus", played: 0, won: 0, drawn: 0, lost: 0, gf: 0, ga: 0, gd: 0, points: 0 },
  { team: "pk-asc", played: 0, won: 0, drawn: 0, lost: 0, gf: 0, ga: 0, gd: 0, points: 0 },
              ...
              <Table>
                ...
                <TableBody>
                  {standings.map((team, index) => {
                    const teamData = clubs.find(club => club.id === team.team);
                    if (!teamData) return null;

                    return (
                      <TableRow key={team.team}>
                        <TableCell>{index + 1}</TableCell>
                        <TableCell className="font-medium">{teamData.name}</TableCell>
